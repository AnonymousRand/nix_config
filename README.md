...
- den also provides a bunch of other things like entities and policies and quirks and namespaces and pipes and diagrams and schema and batteries and parametric aspects and oh lord whatever the heck this is TODO and so basically long story short it's made by people who like do research in programming language theory or something and i spent an entire night reading the docs and i still only use like 30% of den's power probably
- but yes if you look past the surface-level unfamiliarity of the new syntax it can be kinda neat and convenient and clear in its intentions. (there are some things that can be harder like defining *aspect*-level custom options instead of nixos module-level ones, but den is still very much a new thing and it will evolve more in the future)
