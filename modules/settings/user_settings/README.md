# `modules/settings/user_settings/`

user-wide settings that aspects may need to reference, like fonts and theme.

### notes

- a den policy is used to "wire" everything together, by injecting `userSettings` as a context arg whenever a user or home entity is in scope.
