...
exe 'hi markdownBold'          'guifg={{colors.markdown_bold_source.default.hex}}'   'cterm=bold'
exe 'hi markdownCode'          'guifg={{colors.markdown_code_source.default.hex}}'
exe 'hi markdownItalic'        'guifg={{colors.markdown_italic_source.default.hex}}' 'cterm=italic'
...
exe 'hi StatusLine'            'guifg={{colors.accent_3_fg_source.default.hex}}'
                             \ 'guibg={{colors.accent_3_bg_source.default.hex}}'     'cterm=bold'
exe 'hi StatusLineNC'          'guifg={{colors.accent_4_fg_source.default.hex}}'
                             \ 'guibg={{colors.accent_4_bg_source.default.hex}}'     'cterm=none'
exe 'hi Title'                 'guifg={{colors.markdown_title_source.default.hex}}'
