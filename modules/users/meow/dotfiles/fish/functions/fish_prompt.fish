...
function fish_prompt
    ...
    set -l prompt_suffix (echo -n -s (set_color $prompt_scales_pink) "❯" (set_color $prompt_scales_orange) "❯" (set_color $prompt_scales_green) "❯" (set_color $prompt_scales_blue) "❯" (set_color --reset))
