...
exe 'hi CursorLineNr'          'guifg={{ colors.orange_source.default.hex }}'       'cterm=none'
exe 'hi Define'                'guifg={{ colors.keywords_source.default.hex }}'
exe 'hi Error'
                             \ 'guibg={{ colors.error.default.hex }}'
...
exe 'hi MatchParen'
                             \ 'guibg={{ colors.gray_dark_source.default.hex }}'
...
exe 'hi Search'                'guifg={{ colors.on_tertiary.default.hex }}'
                             \ 'guibg={{ colors.tertiary.default.hex }}'
exe 'hi Special'               'guifg={{ colors.constants_source.default.hex }}'
exe 'hi Statement'             'guifg={{ colors.keywords_source.default.hex }}'
exe 'hi StatusLine'            'guifg={{ colors.tertiary.default.hex }}'
