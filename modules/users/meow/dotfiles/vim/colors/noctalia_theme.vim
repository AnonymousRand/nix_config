...
exe 'hi IncSearch'             'guifg={{colors.selection_fg_source.default.hex}}'
                             \ 'guibg={{colors.green_light_source.default.hex}}'     'cterm=none'
...
exe 'hi MatchParen'            'guifg={{colors.selection_fg_source.default.hex}}'
                             \ 'guibg={{colors.green_light_source.default.hex}}'
