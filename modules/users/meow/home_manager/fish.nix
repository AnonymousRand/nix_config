  ...
  flake.homeModules.meow = { config, ... }: {
    programs.fish = {
      ...
      in
        ...
        interactiveShellInit = with config.meow; ''
          set -U fish_color_normal ${colors-${theme}.foreground} --background ${colors-${theme}.background}
          ...
          set -U fish_color_param ${colors-${theme}.pink-xlight}
          ...
          set -U fish_pager_color_selected_background --background ${colors-${theme}.status-bar-foreground}
